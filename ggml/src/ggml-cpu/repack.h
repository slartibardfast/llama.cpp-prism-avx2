...
// PTQ1_0 repacks into the identical layout: the repack pays the base-3 trit
// decode once at load and stores the ternary codes {0,1,2} as 2-bit slots, so
// the steady-state kernels are shared with PQ2_0 (a lossless conversion;
// the ternary code space is a subset of PQ2_0 slot values).
using block_ptq1_0x4 = block<2, 4>;
